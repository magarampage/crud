...
import { Input, Button, Checkbox, Select, DatePicker, Icon, Spin, Table, message, Upload, Form, Modal, Col, Row, Typography, notification } from 'antd';
...
var filterDropdown = (function (name, type, options) {
  return function (_ref) {
    ...
    }), React.createElement("br", null)) : type === 'select' ? React.createElement(Select, {
      value: selectedKeys,
      placeholder: "\u0412\u044B\u0431\u0440\u0430\u0442\u044C",
      onChange: function onChange(e) {
        setSelectedKeys(e);
